...
const PRODUCTS = [
  ...
  {
    name: 'Prismatic Evolutions Pokemon Center ETB',
    msrp: 54.99,
    tier: 1,
    ebaySearchTerm: 'pokemon prismatic evolutions pokemon center elite trainer box',
    pricechartingSet: 'pokemon-scarlet-violet-prismatic-evolutions',
    pricechartingProduct: 'elite-trainer-box-pokemon-center',
    chaseCard: 'Umbreon ex #161 SIR',
    skus: { pokemonCenter: 'TBD', target: 'N/A', walmart: 'N/A', amazon: 'N/A' },
  },
  {
  ...
  {
    name: 'Destined Rivals Pokemon Center ETB',
    msrp: 54.99,
    tier: 1,
    ebaySearchTerm: 'pokemon destined rivals pokemon center elite trainer box',
    pricechartingSet: 'pokemon-scarlet-violet-destined-rivals',
    pricechartingProduct: 'elite-trainer-box-pokemon-center',
    chaseCard: "Ethan's Ho-Oh ex #230",
    skus: { pokemonCenter: 'TBD', target: 'N/A', walmart: 'N/A', amazon: 'N/A' },
  ...
  {
    name: 'Journey Together Pokemon Center ETB',
    msrp: 54.99,
    tier: 2,
    ebaySearchTerm: 'pokemon journey together pokemon center elite trainer box',
    pricechartingSet: 'pokemon-scarlet-violet-journey-together',
    pricechartingProduct: 'elite-trainer-box-pokemon-center',
    chaseCard: "N's SIR",
    skus: { pokemonCenter: 'TBD', target: 'N/A', walmart: 'N/A', amazon: 'N/A' },
